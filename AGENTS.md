...
Every written artifact follows the prose rules in [norms/prose.md](norms/prose.md). Vale checks Markdown and website copy. The writing hook checks development prose. Apply the rules while drafting, not as cleanup.
