...
Required reading before drafting any written artifact for a Portolan repo: READMEs, docs, PR and issue bodies, announcements, commit message bodies, and lasting code comments. Agents MUST apply this rubric while drafting, as a working checklist, not as a post-hoc review. [VOICE.md](VOICE.md) governs what Portolan says; this document governs how any prose is built.
...
- Any sentence that congratulates the reader or talks up the project.

End paragraphs on the last substantive point. The closing slot is for real content, not a victory lap.

## Show, don't tell

Good documentation shows what the software does. It does not tell the reader how to feel about it.
...
- **No badmouthing alternatives.** Don't define the project against competitors. Drop *better than X*, *unlike clunky Y*, *the modern alternative to Z*. Superiority claims read as marketing and date fast. Neutral orientation for migrators is fine ("coming from Express, the equivalent is...").
...
Adapted from the [prose style reference](https://github.com/dbreunig/scaffold-docs-skill/blob/main/references/prose-style.md) in Drew Breunig's scaffold-docs-skill, itself derived from Strunk and White's *The Elements of Style*.
